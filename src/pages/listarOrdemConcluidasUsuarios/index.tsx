            ...
            <div className="container mt-5">
              <div className="row">
                ...
                <div className="d-flex justify-content-end mb-3">
                    <Link href="/listarOrdemAtuaisUsuarios" legacyBehavior>
                  ...
                  <h4 className="fade-in">Ultimos pedidos</h4>
...
export const getServerSideProps = cansSSRAuth(async (ctx) => {
  ...
  try {
    const response = await apiClient.get('/ordens/listarConcluidasUsuario');
    return {
      props: {
