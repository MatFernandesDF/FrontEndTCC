...
export default function listarOrdemAtuaisUsuarios({ ordens }: HomeProps) {
              ...
              <div className="row">
                ...
                <div className="content">
                  <div className="d-flex justify-content-end mb-3">
                    <Link href="/listarOrdemConcluidasUsuarios" legacyBehavior>
                  ...
                  <h2 className="fade-in">Pedidos atuais</h2>
...
export const getServerSideProps = cansSSRAuth(async (ctx) => {
  ...
  try {
    const response = await apiClient.get('/ordens/listarAtuaisUsuario');
    return {
      props: {
